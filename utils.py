...
def def_test_list():
    ...
    test_list.append({'key': '01200', 'idx_a': 0, 'idx_b': 8})
    # test_list.append({'key': '01370', 'idx_a': 0, 'idx_b': 8})
    test_list.append({'key': '01376', 'idx_a': 0, 'idx_b': 8})
    test_list.append({'key': '01425', 'idx_a': 0, 'idx_b': 8})
    test_list.append({'key': '01517', 'idx_a': 0, 'idx_b': 8})
    test_list.append({'key': '01525', 'idx_a': 0, 'idx_b': 8})
    test_list.append({'key': '01575', 'idx_a': 0, 'idx_b': 8})
    # test_list.append({'key': '01689', 'idx_a': 0, 'idx_b': 8})
    # test_list.append({'key': '00178', 'idx_a': 0, 'idx_b': 8})
    test_list.append({'key': '00190', 'idx_a': 0, 'idx_b': 8})
    test_list.append({'key': '02348', 'idx_a': 0, 'idx_b': 8})
    # test_list.append({'key': '02833', 'idx_a': 0, 'idx_b': 8})
    # test_list.append({'key': '02966', 'idx_a': 0, 'idx_b': 8})
    # test_list.append({'key': '00319', 'idx_a': 0, 'idx_b': 8})
    test_list.append({'key': '03366', 'idx_a': 0, 'idx_b': 8})
    test_list.append({'key': '03404', 'idx_a': 0, 'idx_b': 8})
    # test_list.append({'key': '00563', 'idx_a': 0, 'idx_b': 8})
    # test_list.append({'key': '00616', 'idx_a': 0, 'idx_b': 8})
    # test_list.append({'key': '00646', 'idx_a': 0, 'idx_b': 8})
    # test_list.append({'key': '00654', 'idx_a': 0, 'idx_b': 8})
    # test_list.append({'key': '00777', 'idx_a': 0, 'idx_b': 8})
    # test_list.append({'key': '00796', 'idx_a': 0, 'idx_b': 8})
    # test_list.append({'key': '00935', 'idx_a': 0, 'idx_b': 8})
    test_list.append({'key': '00953', 'idx_a': 0, 'idx_b': 8})
    return test_list
