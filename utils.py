...
def def_test_list():
    ...
    test_list.append({'key': '01200', 'idx_a': 0, 'idx_b': -1})
    # test_list.append({'key': '01370', 'idx_a': 0, 'idx_b': 8})
    test_list.append({'key': '01376', 'idx_a': 0, 'idx_b': -1})
    test_list.append({'key': '01425', 'idx_a': 0, 'idx_b': -1})
    test_list.append({'key': '01517', 'idx_a': 0, 'idx_b': -1})
    test_list.append({'key': '01525', 'idx_a': 0, 'idx_b': -1})
    test_list.append({'key': '01575', 'idx_a': 0, 'idx_b': -1})
    # test_list.append({'key': '01689', 'idx_a': 0, 'idx_b': 8})
    # test_list.append({'key': '00178', 'idx_a': 0, 'idx_b': 8})
    test_list.append({'key': '00190', 'idx_a': 0, 'idx_b': -1})
    test_list.append({'key': '02348', 'idx_a': 0, 'idx_b': -1})
    ...
    test_list.append({'key': '03366', 'idx_a': 0, 'idx_b': -1})
    test_list.append({'key': '03404', 'idx_a': 0, 'idx_b': -1})
    ...
    test_list.append({'key': '00953', 'idx_a': 0, 'idx_b': -1})
    return test_list
